...
void graph_calculate_dimensions(struct Point *points_array, unsigned int points_array_size, unsigned int *graph_pixels_width, unsigned int *graph_pixels_height)
{
    int max_distance = 0;
...
void raster_generate_hexcodes(int *hexcodes, unsigned int raster_row_length, unsigned int graph_pixels_width, unsigned int graph_pixels_height, struct Point points_array[], unsigned int points_array_size, struct Point *bresenham_points_array, unsigned int *bresenham_points_array_size)
{
...
void points_compute_bresenham(struct Point *points_array, unsigned int points_array_size, struct Point *bresenham_points_array, unsigned int *bresenham_points_array_size, unsigned int graph_pixels_width, unsigned int graph_pixels_height)
{
    int graph_origin_y_pos = graph_pixels_height / 2;
    int graph_origin_x_pos = graph_pixels_width / 2;
